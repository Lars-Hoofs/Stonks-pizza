            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        @if ($item->image_url)
        <img src="{{ $item->image_url }}" alt="Order Image" class="rounded-md">
    @else
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            ...
                            <h2 class="max-w-xl mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">{{ $item->name }}</h2>
                        ...
                        <form action="{{ route('cart.store', $item) }}" method="post">
                            ...
                            <div class="w-full px-4 mb-4  lg:mb-0">
                                <button
                                   type="submit" class="flex items-center justify-center w-full p-4 text-blue-500 border border-blue-500 rounded-md dark:text-gray-200 dark:border-blue-600 hover:bg-blue-600 hover:border-blue-600 hover:text-gray-100 dark:bg-blue-600 dark:hover:bg-blue-700 dark:hover:border-blue-700 dark:hover:text-gray-300">
